    ...
    public static class CommandHelpCatalog
    {
        private static readonly IReadOnlyList<CommandHelpEntry> Entries =
            new List<CommandHelpEntry>
            {
                ...
                E(CommandIds.Submit, "当前图框提交", "U1S", "只读当前图框清单并提交项目数量到 BOQ", "不修改 CAD；支持多个 frame_20260812/xframe 图框。"),
                ...
                E(CommandIds.DwgExport, "DWG 自动导出", "U1DWG", "按机台导出选中的 frame_20260812/xframe 图框", "同机台图框在独立 DWG 中横向排列。"),
