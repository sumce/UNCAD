...
namespace UNCAD.Infra
{
    ...
    public static class CommandHelpCatalog
    {
        private static readonly IReadOnlyList<CommandHelpEntry> Entries =
            ...
            {
                E(CommandIds.Line, "带标注线段", "U1L", "连续绘制独立 Line 并生成长度文字", "正式命令。"),
                ...
                E(CommandIds.Tray100, "桥架 100", "U1Q1", "为选中曲线生成 100 mm 桥架平行标注", "正式命令。"),
                E(CommandIds.LegacyTray100, "桥架 100", "UNQ1", "调用 U1Q1 的桥架标注功能", "兼容旧命令名。"),
                E(CommandIds.Tray200, "桥架 200", "U1Q2", "为选中曲线生成 200 mm 桥架平行标注", "正式命令。"),
                E(CommandIds.LegacyTray200, "桥架 200", "UNQ2", "调用 U1Q2 的桥架标注功能", "兼容旧命令名。"),
                E(CommandIds.Tray400, "桥架 400", "U1Q4", "为选中曲线生成 400 mm 桥架平行标注", "正式命令。"),
                ...
                E(CommandIds.Conduit, "线管标注", "U1C", "为选中曲线生成线管平行标注", "使用设置中的固定 2000mm 占位文字。"),
