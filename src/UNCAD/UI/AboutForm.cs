...
namespace UNCAD.UI
{
    internal sealed class AboutForm : Form
    {
        public AboutForm()
        {
            ...
            var title = new Label
            {
                Text = "UNCAD", Dock = DockStyle.Top, Height = 48,
                Font = new Font("微软雅黑", 20f, FontStyle.Bold),
                ForeColor = Color.FromArgb(32, 78, 121),
                TextAlign = ContentAlignment.BottomLeft, Padding = new Padding(18, 0, 0, 0)
            };
            var nameplate = new Label
            {
                Text = Branding.Nameplate, Dock = DockStyle.Top, Height = 32,
                Font = new Font("微软雅黑", 10f, FontStyle.Bold),
                Padding = new Padding(20, 4, 0, 0)
            };
            var details = new TableLayoutPanel
            {
                Dock = DockStyle.Top, Height = 116, ColumnCount = 2, RowCount = 4,
            ...
            var legal = new TextBox
            {
                ...
                BorderStyle = BorderStyle.FixedSingle, BackColor = SystemColors.Window,
        ...
        private static void AddDetail(TableLayoutPanel panel, int row, string label, string value)
        {
            ...
            {
                Text = label + ":", AutoSize = true, TextAlign = ContentAlignment.MiddleRight,
                ForeColor = Color.DimGray, Margin = new Padding(0, 4, 8, 2)
            }, 0, row);
            panel.Controls.Add(new Label
            {
                Text = value ?? "", AutoSize = true, Font = new Font("微软雅黑", 9f, FontStyle.Bold),
