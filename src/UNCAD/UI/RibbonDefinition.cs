            ...
            new RibbonPanelDefinition[]
            {
                ...
                new RibbonPanelDefinition("标注",
                    ...
                    RibbonItemDefinition.Button("绘制线条", CommandIds.Line,
                        "连续绘制线段并自动生成长度文字"),
                    RibbonItemDefinition.Button("3D 线路编辑", CommandIds.LineQuick,
                        "选择已有 U1L 线段，载入相连路线并编辑距离"),
                    RibbonItemDefinition.Button("3D 快速绘图", CommandIds.Line3d,
                        "无需选择线段，直接打开东南等轴侧 3D 正交绘图器并写回 CAD"),
